    ...
    public partial class UpdateModelChanges : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasterCategories", x => x.MasterCategoriesId);
                });

            migrationBuilder.CreateTable(
                name: "MasterColorPalettes",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasterColorPalettes", x => x.ColorId);
                });

            migrationBuilder.CreateTable(
                name: "MasterSizeCharts",
                columns: table => new
                {
                    SizesChartId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Size = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasterSizeCharts", x => x.SizesChartId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AttributesId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    ShoeType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    HeelType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    WaterResistance = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SoleMaterial = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductDetails", x => x.AttributesId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariants", x => x.VariantsId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SizeVariants", x => x.SizesId);
                    table.ForeignKey(
                        name: "FK_SizeVariants_ProductVariants_VariantsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItems_ProductVariants_VariantsId",
                        column: x => x.VariantsId,
                        principalTable: "ProductVariants",
                        principalColumn: "VariantsId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_SizeVariants_SizesId",
                        column: x => x.SizesId,
                        principalTable: "SizeVariants",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_ProductVariants_VariantsId",
                        column: x => x.VariantsId,
                        principalTable: "ProductVariants",
                        principalColumn: "VariantsId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_SizeVariants_SizesId",
                        column: x => x.SizesId,
                        principalTable: "SizeVariants",
                        principalColumn: "SizesId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_SizesId",
                table: "CartItems",
                column: "SizesId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItems_VariantsId",
                table: "CartItems",
                column: "VariantsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MasterCategories_CategoryName",
                table: "MasterCategories",
                column: "CategoryName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MasterColorPalettes_ColorName",
                table: "MasterColorPalettes",
                column: "ColorName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MasterSizeCharts_Size",
                table: "MasterSizeCharts",
                column: "Size",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SizeVariants_VariantsId",
                table: "SizeVariants",
                column: "VariantsId");
